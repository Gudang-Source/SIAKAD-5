...
class Penerbit extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumb']='penerbit';
    		$data['title']='Olah Data Buku';
        $data['assign_js']='penerbit/js/index.js';
        load_view('penerbit/tb_penerbit_list', $data);
    }
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $data['title']='Olah Data Buku';
            $data['assign_js']='penerbit/js/index.js';
            load_view('penerbit/tb_penerbit_read', $data);
        } else {
    ...
    public function create()
    {
        ...
        $data['title']='Olah Data Buku';
        $data['assign_js']='penerbit/js/index.js';
        load_view('penerbit/tb_penerbit_form', $data);
    }
