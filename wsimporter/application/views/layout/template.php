    ...
    <nav class="navbar navbar-default navbar-fixed-top <?php echo $temp_pecah2['0']=='live'?"":"navbar-inverse" ?>">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url();?>"><i class="glyphicon glyphicon-sunglasses"></i> STMIK Adhi Guna</a>
        </div>
          ...
          <?php
                if ($this->session->userdata('login')) {
                    echo "<ul class=\"nav navbar-nav\">
                                <li><a href=\"".base_url()."welcome/getProdi\"><i class=\"fa fa-clone\"></i> Prodi</a></li>
                                <li class=\"dropdown\">
