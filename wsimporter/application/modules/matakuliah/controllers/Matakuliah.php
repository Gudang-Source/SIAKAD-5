...
class Matakuliah extends CI_Controller {
	...
	{
		$this->mk();
		//echo $this->session->userdata('id_sp');;
	}
	...
	public function mk()
	{
		...
		$temp_sms = $this->feeder->getrset($this->session->userdata('token'), $this->table1, 'id_sp=\'caded42a-bd40-4b64-8f85-28d6fe3a0a6d\'', $this->order, $this->limit, $this->offset);
