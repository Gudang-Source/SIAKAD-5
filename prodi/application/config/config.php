...
|
*/
$config['encryption_key'] = 'simala_sipad_v2@09311$adhiGUNA';
...
*/
$config['proxy_ips'] = '';
$config['site_title'] = 'SIMALA';
$config['site_title2'] = 'SISTEM INFORMASI AKADEMIK MAHASISWA ALMAMATER STMIK ADHI GUNA';
