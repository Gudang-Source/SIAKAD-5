...
$config['smtp_user']        = 'siakad.sagp@gmail.com';
$config['smtp_pass']        = 'adhigunangampus@iank$123#321';
...
$config['dkim_identity']    = '';                       // DKIM Identity, usually the email address used as the source of the email.              // DKIM Identity,
